...
from .utils import get_carts, UserOrSessionKeyMixin
...
class AddProductToPacket(UserOrSessionKeyMixin, View):
    ...
    def post(self, request):
        ...
        add_to_packet = AddToPacketProduct(is_authenticated, product_id, user_or_session_key)
...
class ChangeCountProductPacket(UserOrSessionKeyMixin, View):
    ...
    def post(self, request):
        ...
        packet_object = ChangeCartQuantity(is_authenticated, user_or_session_key, is_plus, cart_id)
