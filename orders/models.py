...
class Orders(models.Model):
    user = models.ForeignKey(get_user_model(), on_delete=models.SET_DEFAULT,
                             null=True, verbose_name='Пользователь', blank=True,
                             default=None)
    name_receiver = models.CharField(max_length=50, verbose_name='Имя получателя', null=True)
    surname_receiver = models.CharField(max_length=50, verbose_name='Фамилия получателя', null=True)
    ...
    email = models.EmailField(max_length=80, blank=True, verbose_name='Почта', null=True)
    total_price = models.DecimalField(max_digits=17, decimal_places=3, default=0, null=True, verbose_name='Общая стоимость')
